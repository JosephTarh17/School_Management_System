...
Migration 023 should be applied after migration 022. Migration 024 should be applied after migration 023 and before testing new catalog-course creation. Announcement publication and event notification fanout are handled by the backend service-role connection; the frontend never queries Supabase directly.
