...
Migration 023 should be applied after migration 022. Announcement publication and event notification fanout are handled by the backend service-role connection; the frontend never queries Supabase directly.
