<template>
  <section class="space-y-6">
    <header class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><p class="text-xs font-semibold uppercase tracking-[0.2em] text-indigo-600">Attendance</p><h1 class="mt-1 text-2xl font-bold text-slate-950">Attendance reports & alerts</h1><p class="mt-1 text-sm text-slate-500">Review attendance percentages for students in your teaching scope.</p></div><button @click="load" class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white">Refresh</button></header>
