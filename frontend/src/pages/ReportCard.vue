<template>
  <section class="space-y-6">
    ...
    <div v-if="isGuardian" class="rounded-xl border border-indigo-200 bg-indigo-50 px-4 py-3 text-sm text-indigo-900">Viewing selected student: <strong data-no-translate="true" translate="no">{{ selectedStudent?.full_name || 'No student selected' }}</strong></div>
