  ...
  <section class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-5 xl:grid-cols-2">
      <form @submit.prevent="registerStudent" class="space-y-4 rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div><h2 class="font-bold text-slate-900">Register student profile</h2><p class="mt-1 text-xs text-slate-500">A student account is created and linked to the demographic profile.</p></div>
...
const studentForm = reactive({ email: '', password: '', full_name: '', dob: '', phone: '', address: '', emergency_contact_name: '', emergency_contact_phone: '', medical_information: '', disability_accommodations: '', guardian_id: '' })
...
async function registerStudent() {
  ...
  try {
    ...
    message.value = 'Student account and demographic profile created.'
