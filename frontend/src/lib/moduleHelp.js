export const roleProfiles = {
  ...
  guardian: {
    label: 'Guardian',
    intro: 'You monitor linked children, communicate with the school, review published information, respond to notices, and submit requests for review.',
    can: ['View linked-child attendance, published results, schedules, announcements, finance records, and guardian-visible discipline notices.', 'Submit communication, appointment, absence, consent, acknowledgement, and profile-change requests.', 'Track administrator responses and request statuses.'],
    cannot: ['Edit grades, attendance, invoices, discipline records, enrollments, or timetable records.', 'View records for children who are not linked to your guardian profile.'],
...
export const moduleCatalog = [
  ...
  { path: '/guardian-portal', label: 'Children Overview', category: 'Portals', roles: ['guardian'], purpose: 'Monitor linked children and review their permitted academic, attendance, finance, schedule, and notification information.', next: 'Select a linked child before reviewing child-specific information.', steps: ['Choose the child you want to review.', 'Read the current alerts and balances.', 'Open a detailed module when a request or response is required.'] },
  ...
  { path: '/report-card', label: 'Report Card', category: 'Academic', roles: ['student', 'guardian'], purpose: 'View administrator-published semester results, GPA, credits, and course outcomes.', next: 'Use the child selector or current student context to review the correct semester record.', steps: ['Select the student or linked child.', 'Choose the academic year and semester.', 'Read the published result and assessment details.'] },
